...
if __name__ == "__main__":
    ...
    path_to_weights = 'https://github.com/vasevooo/cv_project/blob/main/yolo_model/best.pt'
    model = torch.hub.load('ultralytics/yolov5', 'yolov5s', path=path_to_weights, force_reload=True)
