...
Разработка multipage-приложения на базе `Streamlit` с применением различных методов компьютерного зрения для решения задач по генерации изображений, детекции объектов и очистке от шумов. В проекте участвовало 5 человек: Василий Севостьянов, Мария Козлова, Анна Филина, Ильвир Хасанов и Виктория Князева. 

**Использованные инструмены**
1. Датасеты: MNIST, [Brain tumor object detection](https://www.kaggle.com/datasets/davidbroberts/brain-tumor-object-detection-datasets), [Denoising Dirty Docs](https://www.kaggle.com/competitions/denoising-dirty-documents)
2. Модели: Conditional GAN, YOLOv5, автоэнкодер
3. Деплоймент: Streamlit. [Ссылка](https://vasevooo-cv-project-main-app-6kizmf.streamlit.app/) на приложение
